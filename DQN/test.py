...
def test(agent, env, total_episodes=30, record_video=False):
    ...
    write_gif(frames,"breakout.gif",fps=10)
...
def run(args):
    ...
    '''
    env = Environment('BreakoutNoFrameskip-v4', args, atari_wrapper=True, test=True, render_mode="rgb_array", apply_api_compatibility=True)
